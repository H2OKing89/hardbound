...
class TestZeroPadVol:
    ...
    def test_zero_pad_no_change(self) -> None:
    ...
    def test_zero_pad_multiple(self) -> None:
...
class TestNormalizeWeirdExt:
    ...
    def test_normalize_cue_extensions(self) -> None:
    ...
    def test_normalize_no_weird_ext(self) -> None:
...
class TestCleanBaseName:
    ...
    def test_clean_user_tags(self) -> None:
